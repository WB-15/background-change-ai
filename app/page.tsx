        ...
        <div className='sm:flex sm:items-start sm:justify-between'>
          <div>
            ...
            <div className='mt-2 max-w-xl text-sm text-gray-500'>
              <p>
                Upload any photo or image, then will change daytime to night or
                night to daytime
              </p>
            </div>
          </div>
  ...
  const uploadImage = async (imageURI: any) => {
    try {
      fetch(imageURI)
        ...
        .then((blob) => {
          // Use the Blob object for further processing or save it as a file
          const imageBlob = blob;
          // Example: Save the image as a file
        ...
        .catch((error) => {
          console.error("Error fetching image or converting to Blob:", error);
        });
    } catch (e: any) {
